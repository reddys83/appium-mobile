...
public class HomePage {
    ...
    public void searchForATire(String year,String make, String model,String trim,String zipcode)
    {
        ...
        GenericMethods.selectAnItemFromDropdown(driver,year_Dropdown,year);
        GenericMethods.selectAnItemFromDropdown(driver,make_Dropdown,make);
        GenericMethods.selectAnItemFromDropdown(driver,model_Dropdown,model);
        GenericMethods.selectAnItemFromDropdown(driver,style_Dropdown,trim);
